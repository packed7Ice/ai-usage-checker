...
pub struct AppSettings {
    ...
    pub additional_claude_code_paths: String,
    pub additional_opencode_paths: String,
    pub additional_gemini_paths: String,
...
pub async fn set_settings(
    ...
    let pairs = [
        ...
        ("additional_claude_code_paths", settings.additional_claude_code_paths),
        ("additional_opencode_paths", settings.additional_opencode_paths),
        ("additional_gemini_paths", settings.additional_gemini_paths),
